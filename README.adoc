...
==== [[input_remote_storage]] <<input_remote_storage,remote_storage>>
...
==== [[input_enable_system_backups]] <<input_enable_system_backups,enable_system_backups>>
...
==== [[input_snapshot_cron]] <<input_snapshot_cron,snapshot_cron>>
...
==== [[input_snapshot_retention]] <<input_snapshot_retention,snapshot_retention>>
...
==== [[input_backup_cron]] <<input_backup_cron,backup_cron>>
...
==== [[input_backup_retention]] <<input_backup_retention,backup_retention>>
...
|[[input_storage_over_provisioning_percentage]] <<input_storage_over_provisioning_percentage,storage_over_provisioning_percentage>>
|Set default over-provisioning percentage.
|`number`
|`200`
|no

|[[input_remote_storage]] <<input_remote_storage,remote_storage>>
|Exoscale SOS bucket configuration for backups.
|
...
|[[input_enable_system_backups]] <<input_enable_system_backups,enable_system_backups>>
|Boolean to enable backups of Longhorn system to external storage.
|`bool`
|`false`
|no

|[[input_snapshot_cron]] <<input_snapshot_cron,snapshot_cron>>
|Cron used to configure schedule or Longhorn automatic snapshots.
|`string`
|`"0 /12 * * *"`
|no
...
|[[input_backup_cron]] <<input_backup_cron,backup_cron>>
|Cron used to configure schedule or Longhorn automatic backups.
|`string`
|`"30 /2 * * *"`
|no
