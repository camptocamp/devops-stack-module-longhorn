...
- https://registry.terraform.io/providers/random/latest/docs/resources/string[random_string.cookie_secret] (resource)
...
|[[input_enable_service_monitor]] <<input_enable_service_monitor,enable_service_monitor>>
|Enable the deployment of a service monitor.
|`bool`
|`false`
|no

|[[input_enable_dashboard_ingress]] <<input_enable_dashboard_ingress,enable_dashboard_ingress>>
|Enable the creation of an ingress for the Longhorn's dashboard.
|`bool`
|`false`
|no

|[[input_oidc]] <<input_oidc,oidc>>
|OIDC settings configure Oauth2-Proxy which will be use to protect Longhorn's dashboard.
|
