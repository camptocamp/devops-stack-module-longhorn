...
|[[input_backup_storage]] <<input_backup_storage,backup_storage>>
|Exoscale SOS bucket configuration where the backups will be stored. **This configuration is required if the variable `enable_system_backups` is set to `true`.**
|
